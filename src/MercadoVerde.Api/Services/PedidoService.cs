...
namespace MercadoVerde.Api.Services
{
    public class PedidoService
    {
        ...
        private readonly PasarelaPagoService _pasarela;

        public PedidoService(TiendaDbContext db, InventarioService inventario, PasarelaPagoService pasarela)
        {
            _db = db;
        ...
        public Pedido CrearPedido(CrearPedidoDto dto)
        {
            ...
            // 5) Descontar inventario y persistir
